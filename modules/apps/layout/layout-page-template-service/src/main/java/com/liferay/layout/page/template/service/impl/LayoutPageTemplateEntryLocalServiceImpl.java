...
public class LayoutPageTemplateEntryLocalServiceImpl
	...
	public LayoutPageTemplateEntry addLayoutPageTemplateEntry(
		...
		LayoutPageTemplateEntry layoutPageTemplateEntry =
			addLayoutPageTemplateEntry(
				...
				classTypeId, name, type, 0, false,
				0, 0, parentLayoutPageTemplateCollectionId,
				masterLayoutPlid,
	...
	public LayoutPageTemplateEntry copyLayoutPageTemplateEntry(
		...
		LayoutPageTemplateEntry targetLayoutPageTemplateEntry =
			addLayoutPageTemplateEntry(
				...
				-1, masterLayoutPlid, sourceLayoutPageTemplateEntry.getStatus(),
				serviceContext);
	...
	private LayoutPageTemplateEntry _addLayoutPageTemplateEntry(
		...
		return addLayoutPageTemplateEntry(
			...
			-1, layoutPrototype.getLayoutPrototypeId(), layout.getPlid(), 0, status,
			new ServiceContext());
	}
